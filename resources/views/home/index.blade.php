...
<div class="home-page">
    ...
    <div class="home-section home-section--collections">
            ...
            <div class="split-callout">
                ...
                <div class="split-callout__visual">
                    @if($latestProduct?->galleryMedia->first()?->url)
                        <img
                            ...
                            loading="lazy"
                        >
                        <span class="split-callout__stamp">JANAN / NEW EDIT</span>
                    @else
                        <div class="visual-placeholder">
                            <span>JANAN</span>
                            <strong>کالکشن تازه</strong>
                        </div>
                    @endif
                </div>
                ...
                <div class="split-callout__copy">
                    ...
                    <div class="split-callout__actions">
                        ...
                        <a href="{{ route('categories.index') }}" class="button button--ghost">
                            دسته‌بندی‌ها
                        </a>
                    </div>
                </div>
